...
import { getInTheaters, getPopulars, getTopRated, getTrailers, getTrendings } from '../api/tmbd-api'
import { Card } from '../components/card'
import { Section } from '../components/section'
import { Slider } from '../components/slider/slider'
import { TrailerModal } from '../components/trailer-model'
...
export const Home = () => {
  ...
  const [trendings, setTrendings] = useState<Films[]>([])
  const [inTheaters, setInTheaters] = useState<Films[]>([])
  const [populars, setPopulars] = useState<Films[]>([])
  const [topRatedTv, setTopRatedTv] = useState<Films[]>([])
  const [topRatedMovie, setTopRatedMovie] = useState<Films[]>([])

  const [trailerSrc, setTrailerSrc] = useState('')

  const playTrailer = async (film: Films) => {
  ...
  const goToDetailPage = (film: Films) => {
