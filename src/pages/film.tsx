...
import { getCasts, getDetail, getRecommendations, getTrailers } from '../api/tmbd-api'
...
export const Film = (props: Props) => {
  ...
  const [film, setFilm] = useState<Films| null | undefined>(null)
  ...
  const [recommendations, setRecommendations] = useState<Films[]>([])
